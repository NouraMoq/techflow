...
> **الوصف:** نظام تشغيل متكامل لإدارة محتوى المشاهير وصنّاع المحتوى: استراتيجية → أفكار → سيناريوهات → إنتاج → موافقات → نشر → تحليلات وحملات تجارية. TikTok-first، عربي RTL — مبني بـ Next.js 14 + Prisma.
